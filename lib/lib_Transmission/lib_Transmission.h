...
class Transmission
{
    public:
        ...
        */
        ...
        /** connect to a server at the specified socketaddress
        *
        * @param server socketaddress
        * @returns indicates if the server is connected
        */
        bool                ping(const SocketAddress& server);
        ...
        * @returns indicates if the server is connected
        */
        bool                ping(const string& server, const int& port);
        /** send a command to a server at the specified socketaddress
        *
        * @param ssend sent to server
        * @param server socketaddress
        * @returns indicates if the paquet was send sucessfuly
        */
        bool                set(const string& ssend, const SocketAddress& server);
        /** send a command to a server at the specified port
        *
        * @param ssend sent to server
        * @param server ip
        * @param port port
        * @returns indicates if the paquet was send sucessfuly
        */
        bool                set(const string& ssend, const string& server, const int& port);
        /** send a request to a server at the specified socketaddress and get an anwser
        *
        * @param ssend sent to server
        * @param server socketaddress
        * @returns server response
        */
        string              get(const string& ssend, const SocketAddress& server);
        /** send a request to a server at the specified port and get an anwser
        *
        * @param ssend sent to server
        * @param server ip
        * @param port port
        * @returns server response
        */
        string              get(const string& ssend, const string& server, const int& port);
